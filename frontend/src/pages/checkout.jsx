  ...
  <section className="checkout p-5">
    <div className="container-xxl">
      <div className="row">
        ...
        <h1 className="mb-4 fs-3">Metodo de paypal</h1>
          ...
          <div className="card m-auto">
            ...
            <div id="collapseOne" className="collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
              <div className="card-body payment-card-body">
                <span className="font-weight-normal card-text">Numero de Tarjeta</span>
                ...
                <div className="row mt-3 mb-3">
                  <div className="col-md-6">
                    <span className="font-weight-normal card-text">Expira en:</span>
                    <div className="input">
      ...
      <div className="col-md-6 p-2">
            ...
            <form className="row g-3 mb-3">
              ...
              <div className="col-12">
                ...
                <input type="text" className="form-control" id="inputAddress" placeholder="1234 Mexico city" />
              </div>
              <div className="col-md-6">
                <label htmlFor="inputCity" className="form-label">Pais</label>
              ...
              <div className="col-12 mt-5">
                <button id="button-linker" type="submit" onClick={handlePay}>Proceder la compra</button>
              </div>
            </form>
          </div>
        </div>
