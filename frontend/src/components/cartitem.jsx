      ...
      <div className="row g-3">
        ...
        <div className="col-12 col-md-7">
          <div className="p-3">
            ...
            <p className="cart-item-id">Cantidad de los productos: <b className='text-center mb-3'>{id}</b></p>
            <p className="cart-item-id">Arcticulos en oferta: <b className='text-danger'>{itemsInStock}</b></p>
          </div>
          ...
          <div className="p-3">
            <input type="text" className="form-control" id="coupon" placeholder="Introduce el código de cupón..." />
          </div>
        </div>
      </div>
    </div>
