      ...
      <div className="row">
        <div className="d-flex align-items-center justify-content-between d-none d-md-flex">
          <div className="col-md-8 me-auto">
            <p>Los outfits de tendencia al 100% descuento</p>
          </div>
          <div className="col-md-2">
          <a href="tel:+526183031955">Llamanos al numero +52 (618) 303-1955</a>
          </div>
        ...
        <div className="d-flex align-items-center  justify-content-between d-md-none">
          ...
          <a href="tel:+526183031955">Call us</a>
          </div>
          <div className="col-md-2 m-auto">
            <Link className='links fs-4'><CiMail /></Link>
            <Link className='links fs-4'><BiPhoneCall /></Link>
    ...
    <div className="row align-items-center m-0">
      ...
      <div className="col-md-10 row col-lg-10">
        ...
        <div className="input-group d-none d-md-flex">
          <input type="text" className="form-control" placeholder="Buscar Productos..." aria-label="Find products ..." aria-describedby="basic-addon2" />
        ...
        <div className='menu-links mt-2 d-none d-md-flex d-lg-flex'>
          ...
          <div className='ms-auto gap-3'><NavLink to="/shop" className={location.pathname === '/shop' ? 'active' : 'not-active'} onClick={toggleMenu}>COMPRAR</NavLink></div>
          ...
          <div className='ms-auto gap-3'><NavLink to="/about" className={location.pathname === '/about' ? 'active' : 'not-active'} onClick={toggleMenu}>NOSOTROS</NavLink></div>
          <div className='ms-auto gap-3'><NavLink to="/contact" className={location.pathname === '/contact' ? 'active' : 'not-active'} onClick={toggleMenu}>CONTACTANOS</NavLink></div>
        </div>
        </div>
