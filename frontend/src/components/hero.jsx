        ...
        <div className="row g-4 justify-content-center justify-content-md-between align-items-center">
          <div className="col-6 col-md-4 col-lg-2">
            <div className="card text-center m-auto">
              ...
              <div className="card-body">
                <p className="card-text mb-0">Pedidos Rápidos</p>
              </div>
            </div>
          </div>
          ...
          <div className="col-6 col-md-4 col-lg-2">
            <div className="card text-center m-auto">
              ...
              <div className="card-body">
                <p className="card-text mb-0">Envios Rápidos</p>
              </div>
            </div>
          </div>
          ...
          <div className="col-6 col-md-4 col-lg-2">
            <div className="card text-center m-auto">
              ...
              <div className="card-body">
                <p className="card-text mb-0">Ahorros altos</p>
              </div>
            </div>
          </div>
          ...
          <div className="col-6 col-md-4 col-lg-2">
            <div className="card text-center m-auto">
              ...
              <div className="card-body">
                <p className="card-text mb-0">12hrs de soporte</p>
              </div>
            </div>
          </div>
