        ...
        <div className="col-lg-6">
          <div className="card p-3 m-auto">
            <div className="card-body">
              ...
              <p className="card-text mb-3">Esta es una camisa de suave tejido, con los tradicionales botones al frente, <br /> de corte regular, pero con un estilo moderno en el diseño; tiene manga corta y un muchos colores.<br /> Su estilo será perfecto para combinar con tus pantalones favoritos.</p>


              <div className="d-flex align-items-center mb-3 col-6">
                <button className="btn btn-outline-secondary me-2" onClick={() => removeToCart(product.id)}>-</button>
                ...
                <button className="btn btn-outline-secondary ms-2" onClick={() => addToCart(product.id)}>+</button>
              </div>
          ...
          <div className="card">
            ...
            <h2 className="text-center mb-2">Busca productos similares</h2>
            <p className="mb-2">Tenemos más productos, visita la tienda para obtener increíbles ofertas de nosotros!!</p>
            </div>
